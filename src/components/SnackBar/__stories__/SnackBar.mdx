...
Для коротких сообщений о результате процесса, который уже закончен. Если процесс
всё еще идет, используйте Informer.
...
Добавьте любую из библиотеки иконок с помощью свойства `icon`.
